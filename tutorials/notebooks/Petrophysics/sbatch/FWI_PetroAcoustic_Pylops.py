...
plt.legend(title='Frequência (Hz)')
...
plt.subplot(1,3,1)
plt.imshow((phi - phi_inv).T, aspect='auto',cmap='seismic')
plt.title('${\phi}$')
plt.colorbar()
plt.subplot(1,3,2)
plt.imshow((vsh - vsh_inv).T, aspect='auto',cmap='seismic')
plt.title('Vsh')
plt.colorbar()
plt.subplot(1,3,3)
plt.imshow((sw - sw_inv).T, aspect='auto',cmap='seismic')
plt.title('Sw')
plt.colorbar()
plt.tight_layout()
plt.savefig('images/Diff_PylopsPetroAcousitc_FWI.png', format='png', dpi=200)