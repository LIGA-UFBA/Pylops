...
class AcousticWaveSolver:
    ...
    def forward(self, src=None, rec=None, u=None, model=None, save=None, **kwargs):
        ...
        allowed = {'phi', 'vsh', 'sw', 'a1', 'a2', 'a3', 'a4'}
        # (dt entra separado; u/src/rec são passados explicitamente)
    ...
    def jacobian_adjoint(self, rec, u, src=None, v=None, grad1=None, grad2=None, grad3=None, model=None,
        ...
        # grad1 = Function(name='grad1', grid=self.model.grid) if 'grad1' not in kwargs else kwargs['grad1']
        # grad2 = Function(name='grad2', grid=self.model.grid) if 'grad2' not in kwargs else kwargs['grad2']
        # grad3 = Function(name='grad3', grid=self.model.grid) if 'grad3' not in kwargs else kwargs['grad3']
        ...
        if checkpointing:
            ...
            summary = self.op_grad().apply(rec=rec, grad1=grad1, grad2=grad2, grad3=grad3, v=v, u=u, dt=dt,
                                           **kwargs)
